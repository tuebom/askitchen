                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <div class="btn-group">
                                                ...
                                                <?php echo anchor(isset($_SESSION['last_page'])?'admin/inventory?q='.$_SESSION['q'].'&p='.$_SESSION['last_page']:'admin/inventory', lang('actions_cancel'), array('class' => 'btn btn-default btn-flat')); ?>
                                            </div>
                                        </div>
                                    </div>
                                    <?php echo form_close();?>
