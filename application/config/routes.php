...
$route['products/(brand)/(:any)'] = 'products/index/brand/$1';
...
$route['admin/subcategories/(:any)'] = 'admin/subcategories/index/$1';
$route['admin/subcategories2/(:any)'] = 'admin/subcategories2/index/$1';
